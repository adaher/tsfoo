...
module.exports = function(grunt) {
    ...
    grunt.registerTask('rjs', [ 'clean', 'typescript:amd_for_bundle', 'requirejs:rjs', 'fix_maps' ]);
    grunt.registerTask('almond', [ 'clean', 'typescript:amd_for_bundle', 'requirejs:almond', 'fix_maps' ]);
